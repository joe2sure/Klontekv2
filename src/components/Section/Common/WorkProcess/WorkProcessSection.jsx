          ...
          <div className="col-lg-4 col-md-6">
            <div className="tekup-iconbox-wrap2">
              ...
              <div className="tekup-iconbox-data2">
                ...
                <p>We analyze your business needs and develop comprehensive strategies to establish a solid foundation for growth.</p>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="tekup-iconbox-wrap2">
              ...
              <div className="tekup-iconbox-data2">
                ...
                <p>Our expert team implements tailored solutions, creating innovative systems and processes to accelerate your business growth.</p>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
            <div className="tekup-iconbox-wrap2">
              ...
              <div className="tekup-iconbox-data2">
                ...
                <p>We ensure quality through rigorous testing and provide ongoing support to optimize performance and sustain long-term success.</p>
              </div>
            </div>
          </div>
        </div>
